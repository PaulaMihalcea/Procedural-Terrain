...
function main() {
    ...
    let matrixDimensions = 5; // Number of rows/columns of the terrain square matrix
    ...
    */
    ...
    function update() { // TODO
        ...
        console.log(-tileLength * maxDistance, terrain[centralTileI][centralTileJ].position.x, tileLength * maxDistance, xDir)
